...
new_idx = [each.upper() for each in sales.index]
...
# Print the sales DataFrame. This has been done for you,
#     so hit 'Submit Answer' to verify that indeed you have an index with the fields state and month!
